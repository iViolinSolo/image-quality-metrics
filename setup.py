...
# Package meta-data.
NAME = 'iq_metrics'
DESCRIPTION = 'Image quality evalution, calculating image related metrics.'
URL = 'https://github.com/iViolinSolo/image-quality-metrics'
...
ENTRY_POINTS = {
    'console_scripts': [
        'iq_metrics = iq_metrics.image_quality_evaluator:main',
    ],
}
